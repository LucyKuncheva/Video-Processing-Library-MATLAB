function [Matching,Cost] = assignment_hungarian(Perf)
%=======================================================================
%assignment_hungarian Finding a matching with minimum cost.
%   [Matching,Cost] = assignment_hungarian(Perf) finds an optimal 
%   Matching between the rows and the colums of matrix Perf using the 
%   Munkres algorithm (Hungarian algorithm).
%   
%   Input -----
%      'Perf': an N-by-M matrix with costs/weights. 
%
%   Output -----
%      'Matching': N-by-M matrix with ones in the place of the matchings 
%                  and zeros elsewhere.
%      'Cost': the cost of the minimum matching
%
%   Example:
%      [Matching,Cost] = assignment_hungarian(rand(5,7))
%========================================================================
...
% Define variables
  ...
  M = zeros(P_size);        % A mask that shows if a position is starred 
                            %    or primed
...
%         all primes and uncover every line in the matrix.  Return to 
%         Step 3.
%**************************************************************************
